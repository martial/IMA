...
VideoManager::VideoManager() {
    ...
    mireColors.push_back(ofColor(255,0,0));
    mireColors.push_back(ofColor(0,255,0));
    mireColors.push_back(ofColor(0,0,255));
...
void VideoManager::prepass(bool bDebugDraw) {
        ...
        for(int i =0; i<players.size(); i++) {
            ...
            player->draw(x,y);
             ...
             if(bDebugDraw) {
                ...
                ofSetColor(mireColors[i]);
                ofRect(x,y, player->getWidth(), player->getHeight());
